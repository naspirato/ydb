...
def main():
    ...
    if main_sizes_result and current_sizes_result:
        ...
        stripped_diff_perc = Decimal(
            stripped_bytes_diff * 100 / main_size_bytes
        ...
        comment = (
            ...
            f"|**{format_number(main_size_stripped_bytes)}** Bytes|**{format_number(current_size_stripped_bytes)}|**{stripped_sign}{human_readable_stripped_size_diff}|{stripped_sign}{stripped_diff_perc}%%|\n\n"
