...
def main():
    ...
    parh_in_repo = '.github/config/'
    muted_ya_path = parh_in_repo + 'muted_ya.txt'  # имя файла, для которого нужно получить diff
    added_lines_file = parh_in_repo + 'mute_info/added_muted_line.txt'
    added_lines_file_muted = parh_in_repo + 'mute_info/added_muted_test.txt'
    removed_lines_file = parh_in_repo + 'mute_info/removed_muted_line.txt'
    removed_lines_file_muted = parh_in_repo + 'mute_info/removed_muted_test.txt'
    all_tests_file =  parh_in_repo + 'mute_info/all_tests.txt'
    all_muted_tests_file =  parh_in_repo + 'mute_info/all_muted_tests.txt'
